...
public class Aplicacion {
    ...
    public static void main(String[] args) { Empresa empresa = new Empresa("Mi Empresa", new ArrayList<>());

        String[] opciones = {"Agregar Empleado Planta", "Agregar Empleado Temporal", "Agregar Empleado Venta",
                "Listar Empleados", "Buscar Empleado", "Mayor Salario", "Calcular Nómina", "Salir"};
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    String documentoTtemporal = JOptionPane.showInputDialog("Documento:");
                    ...
                    empresa.agregarEmpleado(new EmpleadoTemporal(nombreTemporal, documentoTtemporal, edadTemporal, salarioBaseTemporal,
