        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    String docBuscar = JOptionPane.showInputDialog(null, "Ingrese el documento a buscar:", "Buscar Empleado", JOptionPane.QUESTION_MESSAGE);

                    if (docBuscar != null && !docBuscar.isBlank()) {
                        Empleado encontrado = empresa.buscarEmpleado(docBuscar);

                        if (encontrado != null) {

                            String msg = "Empleado Encontrado:\n" +
                                    "----------------------------\n" +
                                    "Nombre: " + encontrado.getNombre() + "\n" +
                                    "Documento: " + encontrado.getDocumento() + "\n" +
                                    "Categoría: " + encontrado.getCategoriaEmpleado() + "\n" +
                                    "Salario Neto: $" + String.format("%.2f", encontrado.calcularSalarioNeto());

                            JOptionPane.showMessageDialog(null, msg, "Resultado", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encontró el empleado con documento: " + docBuscar, "Sin resultados", JOptionPane.WARNING_MESSAGE);
                        }
                    }
                    break;
